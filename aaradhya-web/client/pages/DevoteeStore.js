          ...
          <div className="container mx-auto">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                >
                  <Home className="h-5 w-5 mr-1 ml-2  " strokeWidth={3} />{" "}
                  Aaraadhya Home
                </a>
        ...
        <main className="container mx-auto py-4 px-4">
          ...
          <div className="bg-amber-100 rounded-lg p-6 mb-6 relative overflow-hidden">
            <div className="max-w-2xl relative z-10">
              ...
              <p className="text-amber-800 mb-4">
                Book poojas, order prasadam, and shop for authentic temple
                items. All offerings are performed by temple priests and
            ...
            <div className="flex-grow">
              ...
              <div className="bg-white rounded-lg shadow-sm p-4 mb-4 flex justify-between items-center">
                <h2 className="font-bold text-gray-800">
                  ...
                  {selectedTemple !== "all" &&
                    ` for ${
                      temples.find((t) => t.id === selectedTemple)?.name
                    }`}
                </h2>
          ...
          <div className="bg-amber-100 rounded-lg p-6 text-center mt-8">
            ...
            <p className="text-gray-700 text-sm mb-4">
              Subscribe to receive notifications about special poojas and
              limited items.
            </p>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-xl p-8 max-w-md text-center">
          ...
          <p className="text-gray-600 mb-6">
            We're working hard to bring this feature to you. The DevoteeStore
            will be available in the near future with all temple offerings and
            prasadam.
          </p>
          ...
          <button className="text-orange-600 hover:text-orange-700 font-medium" onClick={() => window.location.href = "/"}>
            Return to Home
          </button>
        </div>
      </div>
