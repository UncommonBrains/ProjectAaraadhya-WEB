...
import { Bell, Settings, LogOut, Phone, Info, Calendar, Star, Share2, Menu, ChevronDown } from "lucide-react";
        ...
        >
          <nav className="flex flex-col space-y-2">
            ...
            <div className="border-t border-amber-100 pt-2">
              <button
                className="flex items-center justify-between w-full text-gray-600 hover:text-amber-900 p-2"
                onClick={() => setShowMoreDropdown(!showMoreDropdown)}
              >
                More
