...
const TempleStore = () => {
  ...
  const products = [
    {
      ...
      reviews: 128,
      image: "abhishekam",
      description: "Special abhishekam with panchamrut for your chosen deity with priest's blessings sent directly to you.",
      bestSeller: true,
    },
    {
      id: 2,
      ...
      reviews: 352,
      image: "laddu",
      description: "Sacred Laddu prasadam blessed at Tirupati temple, packaged and delivered to your doorstep.",
      bestSeller: true,
    },
    {
      id: 3,
    ...
    },
    {
      ...
      reviews: 63,
      image: "diwali",
      description: "Complete Lakshmi-Ganesh pooja with special diya and prasadam. Book in advance for the auspicious festival.",
      limited: true,
    },
    {
      id: 6,
  ...
  const filteredProducts = products.filter(product => {
    ...
    const templeMatch = selectedTemple === "all" || product.temple === selectedTemple || product.temple === "All Temples";
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      ...
      {/* Navigation */}
      <nav className="bg-orange-700 text-white py-2 shadow-md">
        <div className="container mx-auto">
          <div className="flex items-center space-x-6 overflow-x-auto pb-1 text-sm">
            ...
            <a href="#" className="whitespace-nowrap font-medium">Best Sellers</a>
            <a href="#" className="whitespace-nowrap">Today's Deals</a>
            <a href="#" className="whitespace-nowrap">New Releases</a>
            <a href="#" className="whitespace-nowrap">Festival Specials</a>
            <a href="#" className="whitespace-nowrap">Customer Service</a>
            <a href="#" className="whitespace-nowrap">Temple Directory</a>
          </div>
        </div>
      </nav>
      ...
      <main className="container mx-auto py-4 px-4">
        ...
        <div className="bg-amber-100 rounded-lg p-6 mb-6 relative overflow-hidden">
          <div className="max-w-2xl relative z-10">
            ...
            <p className="text-amber-800 mb-4">
              Book poojas, order prasadam, and shop for authentic temple items. All offerings are performed by temple priests and delivered to your doorstep.
            </p>
          ...
          <div className="w-full md:w-64 flex-shrink-0">
            ...
            <div className="bg-orange-50 rounded-lg shadow-sm p-4 border border-orange-100">
              ...
              <p className="text-sm text-gray-700 mb-3">
                Our devotee support team is available to assist you with any questions about temple offerings.
              </p>
          ...
          <div className="flex-grow">
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 mb-4 flex justify-between items-center">
              <h2 className="font-bold text-gray-800">
                ...
                {selectedTemple !== "all" && ` for ${temples.find(t => t.id === selectedTemple)?.name}`}
              </h2>
              <div className="flex items-center">
                ...
                <div key={product.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
                  <div className="relative">
                    <div className="bg-amber-100 h-48 flex items-center justify-center">
                      <span className="text-amber-800 font-serif text-lg">{product.image}</span>
                    </div>
                  ...
                  <div className="p-4">
                    <div className="text-xs text-orange-600 mb-1">{product.temple}</div>
            ...
            {filteredProducts.length === 0 && (
              <div className="bg-white rounded-lg shadow-sm p-8 text-center">
                <div className="text-amber-900 font-bold mb-2">No offerings found</div>
            ...
            {filteredProducts.length > 0 && (
              <div className="mt-6 flex justify-center">
                <div className="flex space-x-1">
                  ...
                  <button className="px-3 py-1 rounded border text-sm bg-orange-500 text-white">1</button>
        ...
        <div className="mt-8">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Recommended Based on Your Browsing</h2>
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
            {products.slice(0, 6).map(product => (
              <div key={`rec-${product.id}`} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div className="bg-amber-100 h-24 flex items-center justify-center">
                  <span className="text-amber-800 font-serif text-xs">{product.image}</span>
                </div>
                <div className="p-2">
                  ...
                  <div className="font-bold text-sm text-amber-900">₹{product.price}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="#" className="hover:text-white">About DevoteeStore</a></li>
                <li><a href="#" className="hover:text-white">Temple Partnerships</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="#" className="hover:text-white">Vishnu Temples</a></li>
                <li><a href="#" className="hover:text-white">Shiva Temples</a></li>
                <li><a href="#" className="hover:text-white">Shakti Temples</a></li>
                <li><a href="#" className="hover:text-white">Ganesha Temples</a></li>
                <li><a href="#" className="hover:text-white">All Temples Directory</a></li>
              </ul>
            </div>
            <div>
