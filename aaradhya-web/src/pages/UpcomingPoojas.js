      ...
      <main className="container mx-auto p-4 grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="grid grid-cols-7 gap-1 mt-2">
                {Array.from({ length: 31 }, (_, i) => (
                  <div
                    ...
                    ${i + 1 === 23 || i + 1 === 25 || i + 1 === 28 ? "bg-amber-200 text-amber-900" : "text-gray-600"}`}
                  >
                    {i + 1}
                  </div>
                ))}
        ...
        <div className="md:col-span-3 space-y-6">
          ...
          <div className="flex flex-wrap space-x-3 mb-6 text-sm">
            {["All", "Vishnu", "Shiva", "Shakti", "Ganesh", "Murugan"].map(
              (filter) => (
                <button
                  key={filter}
                  className={`${
          ...
          <div className="flex justify-between items-center mb-4">
            <p className="text-sm text-gray-600">
              Showing <span className="font-medium">{filteredMyPoojas.length + filteredRecommendedPoojas.length}</span> poojas
            </p>
              ...
              {getSortedMyPoojas().map((pooja) => (
                ...
                >
                  <div className="p-4 border-l-4 border-orange-500">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-600 mb-1">{pooja.temple}</p>
              ...
              <div className="bg-white/80 rounded-lg p-4 backdrop-blur-sm">
                <div className="flex justify-between">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Only 5 slots left</p>
                  </div>
                </div>
              ...
              <div className="bg-white/80 rounded-lg p-4 backdrop-blur-sm">
                <div className="flex justify-between">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-500 mt-1">12 slots available</p>
                  </div>
                </div>
                <button className="w-full mt-3 bg-orange-500 text-white rounded py-2 text-sm">
                  Book Now
