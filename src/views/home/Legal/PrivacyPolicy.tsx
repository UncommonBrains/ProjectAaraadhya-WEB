    ...
    <div className="min-h-screen bg-amber-50 font-sans">
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">Your privacy is important to us at Aaraadhya</p>
          ...
          <div className="rounded-lg border border-amber-100 bg-white p-6 shadow-sm md:p-8">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-700 leading-relaxed">
                At Aaraadhya, we respect your privacy and are committed to protecting your personal data. 
            ...
            <section className="mb-6">
              ...
              <div className="rounded-lg bg-orange-50 p-4">
                ...
                <div className="text-sm text-gray-600">
                  <p>Email: privacy@aaraadhya.in</p>
                  <p>Phone: +91 9400446095</p>
                  <p>Address: Krishnamana Illam, Cheravally, Kayamkulam PO,<br /> Alappuzha, Kerala - 690502, India</p>
                </div>
              </div>
            </section>
          </div>
